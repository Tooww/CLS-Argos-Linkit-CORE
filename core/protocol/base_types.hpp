...
enum class ParamID {
	...
	BARO_SENSOR_ENABLE_TX_MAX_SAMPLES,		// Tom //
	BARO_SENSOR_ENABLE,						// Tom //
	BARO_SENSOR_PERIODIC,  					// Tom //
	BARO_SENSOR_ENABLE_TX_SAMPLE_PERIOD, 	// Tom //
	BARO_SENSOR_ENABLE_TX_MODE, 			// Tom //
